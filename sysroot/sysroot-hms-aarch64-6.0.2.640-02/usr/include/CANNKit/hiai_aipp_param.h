 ...
 *
 * @brief APIs for creating dynamic AIPP objects and setting and querying relevant parameters for CANN model
 * inference.
 *
...
#ifndef CANN_AIPP_PARAM_H
#define CANN_AIPP_PARAM_H
...
/**
 * @brief Image format enums of input and output tensors supported by CANN inference.
 *
 *        CANN only supports the image format enums declared below.
 *
 * @since 4.1.0(11)
 */
typedef enum {
