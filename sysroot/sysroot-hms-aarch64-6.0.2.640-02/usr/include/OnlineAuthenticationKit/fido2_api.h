...
/**
 * @brief Defines the status of token binding.
 * @since 6.0.0(20)
 */
...
typedef enum FIDO2_AttestationConveyancePreference {
    /** Relying parties are not interested in validator proof, default value. */
    FIDO2_NONE = 0,
 ...
 * for some operations, but do not require other operations. Enum types are defined to
...
/**
 * @brief Enumerates the authenticator attachments.
 * @since 6.0.0(20)
 */
...
/**
 * @brief Enumerates the authenticator transport types.
 * @since 6.0.0(20)
 */
...
/**
 * @brief Enumerates the public key credential hints.
 * @since 6.0.0(20)
 */
...
/**
 * @brief Enumerates the public key credential types.
 * @since 6.0.0(20)
 */
...
/**
 * @brief Enumerates client capabilities.
 * @since 6.0.0(20)
 */
...
/**
 * @brief Enumerates the mediation requirements.
 * @since 6.0.0(20)
 */
...
/**
 * @brief Defines the struct for obtaining authentication results.
 * @since 6.0.0(20)
 */
...
/**
 * @brief 
 * Defines the struct for obtaining authentication results.
 * @since 6.0.0(20)
 */
...
/**
 * @brief 
 * Defines the authenticator transport array.
 * @since 6.0.0(20)
 */
...
/**
 * @brief Defines the attribute that represents the relying party when creating a new credential.
 * @since 6.0.0(20)
 */
...
/**
 * @brief Defines the FIDO2 authentication request parameters.
 * @since 6.0.0(20)
 */
...
/**
 * @brief 
 * The array of the relying party may use this optional member to specify a
...
/**
 * @brief Defines the credential request options.
 * @since 6.0.0(20)
 */
...
typedef struct FIDO2_Capability {
    /** Indicates supported FIDO2 capabilities. */
    FIDO2_ClientCapability capability;
    /** Indicates whether the capability is available. */
    bool isSupported;
} FIDO2_Capability;
 ...
 * @return Returns {@link FIDO2_SUCCESS} if the function is executed successfully; returns a specific error
 * code if the function fails to be executed.
 * {@link FIDO2_DEVICE_NOT_SUPPORT}  801 - Device type error. since 6.0.1(21)
 * {@link FIDO2_TIMEOUT} 1021300005 - Time out.
 * {@link FIDO2_UNKNOWN_ERROR} 1021300007 - Unknown error.
 * {@link FIDO2_DATA_ERROR} 1021300009 - Data error.
 ...
 * @return Returns {@link FIDO2_SUCCESS} if the function is executed successfully; returns a specific error
 * code if the function fails to be executed.
 * {@link FIDO2_PERMISSION_DENIED}  201 - Permission denied.
 * {@link FIDO2_DEVICE_NOT_SUPPORT}  801 - Device type error. since 6.0.1(21)
 * {@link FIDO2_TIMEOUT} 1021300005 - Time out.
 * {@link FIDO2_UNKNOWN_ERROR} 1021300007 - Unknown error.
 * {@link FIDO2_DATA_ERROR} 1021300009 - Data error.
 ...
 * @param options The FIDO2 authentication request options.
 * @param tokenBinding The FIDO2 authentication tokenBinding.
 * @param origin The security origin when calling the method.
 * @param publicKeyAssertionCredential FIDO2 authentication response.
 * @return Returns {@link FIDO2_SUCCESS} if the function is executed successfully; returns a specific error
 * code if the function fails to be executed.
 * {@link FIDO2_PERMISSION_DENIED}  201 - Permission denied.
 * {@link FIDO2_DEVICE_NOT_SUPPORT}  801 - Device type error. since 6.0.1(21)
