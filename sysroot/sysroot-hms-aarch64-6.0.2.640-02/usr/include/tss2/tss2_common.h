 ...
 * @file tss2_common.h
 *
 * @brief Defines common info for tss2.
 *
...
#define TSS2_RC_LAYER(layer)        ((TSS2_RC)((layer) << TSS2_RC_LAYER_SHIFT))
#define TSS2_RC_LAYER_MASK          TSS2_RC_LAYER(0xff)

/* These layer codes are reserved for software layers defined in the TCG
 * specifications.
*/
#define TSS2_TPM_RC_LAYER           TSS2_RC_LAYER(0) /* base is a TPM2_RC_* */
#define TSS2_FEATURE_RC_LAYER       TSS2_RC_LAYER(6) /* base is a TSS2_BASE_RC_* */
#define TSS2_ESYS_RC_LAYER          TSS2_RC_LAYER(7) /* base is a TSS2_BASE_RC_* */
#define TSS2_SYS_RC_LAYER           TSS2_RC_LAYER(8) /* base is a TSS2_BASE_RC_* */
#define TSS2_MU_RC_LAYER            TSS2_RC_LAYER(9) /* base is a TSS2_BASE_RC_* */
#define TSS2_TCTI_RC_LAYER          TSS2_RC_LAYER(10) /* base is a TSS2_BASE_RC_* */
#define TSS2_RESMGR_RC_LAYER        TSS2_RC_LAYER(11) /* base is a TSS2_BASE_RC_* */
#define TSS2_RESMGR_TPM_RC_LAYER    TSS2_RC_LAYER(12) /* base is a TPM_RC_* */
...
#define TSS2_BASE_RC_INVALID_SESSIONS               13U /* The TPM command doesn't use the number of sessions provided by the caller */
#define TSS2_BASE_RC_NO_DECRYPT_PARAM               14U /* A session with its TPMA_SESSION_DECRYPT bit set was passed to a TPM command that doesn't  support encryption of the first command parameter. */
#define TSS2_BASE_RC_NO_ENCRYPT_PARAM               15U /* A session with its TPMA_SESSION_ENCRYPT bit set was passed to a TPM command that doesn't support encryption of the first response parameter. */
...
#define TSS2_BASE_RC_INTERNAL_ERROR                 52U
#define TSS2_BASE_RC_SAPI_INIT                      53U
#define TSS2_BASE_RC_CANCEL                         54U
...
#define TSS2_TCTI_RC_GENERAL_FAILURE \
    ((TSS2_RC) (TSS2_TCTI_RC_LAYER | TSS2_BASE_RC_GENERAL_FAILURE))
#define TSS2_TCTI_RC_NOT_IMPLEMENTED \
    ((TSS2_RC) (TSS2_TCTI_RC_LAYER | TSS2_BASE_RC_NOT_IMPLEMENTED))
#define TSS2_TCTI_RC_BAD_CONTEXT \
    ((TSS2_RC) (TSS2_TCTI_RC_LAYER | TSS2_BASE_RC_BAD_CONTEXT))
#define TSS2_TCTI_RC_ABI_MISMATCH \
    ((TSS2_RC) (TSS2_TCTI_RC_LAYER | TSS2_BASE_RC_ABI_MISMATCH))
#define TSS2_TCTI_RC_BAD_REFERENCE \
    ((TSS2_RC) (TSS2_TCTI_RC_LAYER | TSS2_BASE_RC_BAD_REFERENCE))
#define TSS2_TCTI_RC_INSUFFICIENT_BUFFER \
    ((TSS2_RC) (TSS2_TCTI_RC_LAYER | TSS2_BASE_RC_INSUFFICIENT_BUFFER))
#define TSS2_TCTI_RC_BAD_SEQUENCE \
    ((TSS2_RC) (TSS2_TCTI_RC_LAYER | TSS2_BASE_RC_BAD_SEQUENCE))
#define TSS2_TCTI_RC_NO_CONNECTION \
    ((TSS2_RC) (TSS2_TCTI_RC_LAYER | TSS2_BASE_RC_NO_CONNECTION))
...
#define TSS2_TCTI_RC_NOT_PERMITTED \
    ((TSS2_RC) (TSS2_TCTI_RC_LAYER | TSS2_BASE_RC_NOT_PERMITTED))
#define TSS2_TCTI_RC_MALFORMED_RESPONSE \
    ((TSS2_RC) (TSS2_TCTI_RC_LAYER | TSS2_BASE_RC_MALFORMED_RESPONSE))
#define TSS2_TCTI_RC_NOT_SUPPORTED \
    ((TSS2_RC) (TSS2_TCTI_RC_LAYER | TSS2_BASE_RC_NOT_SUPPORTED))
#define TSS2_TCTI_RC_MEMORY \
    ((TSS2_RC)(TSS2_TCTI_RC_LAYER | TSS2_BASE_RC_MEMORY))

/* SAPI response codes */
#define TSS2_SYS_RC_GENERAL_FAILURE \
    ((TSS2_RC) (TSS2_SYS_RC_LAYER | TSS2_BASE_RC_GENERAL_FAILURE))
#define TSS2_SYS_RC_ABI_MISMATCH \
    ((TSS2_RC) (TSS2_SYS_RC_LAYER | TSS2_BASE_RC_ABI_MISMATCH))
#define TSS2_SYS_RC_BAD_REFERENCE \
    ((TSS2_RC) (TSS2_SYS_RC_LAYER | TSS2_BASE_RC_BAD_REFERENCE))
#define TSS2_SYS_RC_INSUFFICIENT_BUFFER \
    ((TSS2_RC) (TSS2_SYS_RC_LAYER | TSS2_BASE_RC_INSUFFICIENT_BUFFER))
#define TSS2_SYS_RC_BAD_SEQUENCE \
    ((TSS2_RC) (TSS2_SYS_RC_LAYER | TSS2_BASE_RC_BAD_SEQUENCE))
...
#define TSS2_SYS_RC_NO_DECRYPT_PARAM \
    ((TSS2_RC) (TSS2_SYS_RC_LAYER | TSS2_BASE_RC_NO_DECRYPT_PARAM))
#define TSS2_SYS_RC_NO_ENCRYPT_PARAM \
    ((TSS2_RC) (TSS2_SYS_RC_LAYER | TSS2_BASE_RC_NO_ENCRYPT_PARAM))
#define TSS2_SYS_RC_BAD_SIZE \
    ((TSS2_RC) (TSS2_SYS_RC_LAYER | TSS2_BASE_RC_BAD_SIZE))
#define TSS2_SYS_RC_MALFORMED_RESPONSE \
    ((TSS2_RC) (TSS2_SYS_RC_LAYER | TSS2_BASE_RC_MALFORMED_RESPONSE))
...
#define TSS2_SYS_RC_INSUFFICIENT_RESPONSE \
    ((TSS2_RC) (TSS2_SYS_RC_LAYER | TSS2_BASE_RC_INSUFFICIENT_RESPONSE))
#define TSS2_SYS_RC_INCOMPATIBLE_TCTI \
    ((TSS2_RC) (TSS2_SYS_RC_LAYER | TSS2_BASE_RC_INCOMPATIBLE_TCTI))
...
#define TSS2_MU_RC_GENERAL_FAILURE \
    ((TSS2_RC) (TSS2_MU_RC_LAYER | TSS2_BASE_RC_GENERAL_FAILURE))
#define TSS2_MU_RC_BAD_REFERENCE \
    ((TSS2_RC) (TSS2_MU_RC_LAYER | TSS2_BASE_RC_BAD_REFERENCE))
...
#define TSS2_MU_RC_INSUFFICIENT_BUFFER \
    ((TSS2_RC) (TSS2_MU_RC_LAYER | TSS2_BASE_RC_INSUFFICIENT_BUFFER))

/* ESAPI response codes */
#define TSS2_ESYS_RC_GENERAL_FAILURE \
    ((TSS2_RC) (TSS2_ESYS_RC_LAYER | TSS2_BASE_RC_GENERAL_FAILURE))
#define TSS2_ESYS_RC_NOT_IMPLEMENTED \
    ((TSS2_RC) (TSS2_ESYS_RC_LAYER | TSS2_BASE_RC_NOT_IMPLEMENTED))
#define TSS2_ESYS_RC_BAD_CONTEXT \
    ((TSS2_RC) (TSS2_ESYS_RC_LAYER | TSS2_BASE_RC_BAD_CONTEXT))
#define TSS2_ESYS_RC_ABI_MISMATCH \
    ((TSS2_RC) (TSS2_ESYS_RC_LAYER | TSS2_BASE_RC_ABI_MISMATCH))
#define TSS2_ESYS_RC_BAD_REFERENCE \
    ((TSS2_RC) (TSS2_ESYS_RC_LAYER | TSS2_BASE_RC_BAD_REFERENCE))
#define TSS2_ESYS_RC_BAD_SEQUENCE \
    ((TSS2_RC) (TSS2_ESYS_RC_LAYER | TSS2_BASE_RC_BAD_SEQUENCE))
...
#define TSS2_ESYS_RC_NO_DECRYPT_PARAM \
    ((TSS2_RC) (TSS2_ESYS_RC_LAYER | TSS2_BASE_RC_NO_DECRYPT_PARAM))
#define TSS2_ESYS_RC_NO_ENCRYPT_PARAM \
    ((TSS2_RC) (TSS2_ESYS_RC_LAYER | TSS2_BASE_RC_NO_ENCRYPT_PARAM))
#define TSS2_ESYS_RC_MALFORMED_RESPONSE \
    ((TSS2_RC) (TSS2_ESYS_RC_LAYER | TSS2_BASE_RC_MALFORMED_RESPONSE))
#define TSS2_ESYS_RC_INSUFFICIENT_RESPONSE \
    ((TSS2_RC) (TSS2_ESYS_RC_LAYER | TSS2_BASE_RC_INSUFFICIENT_RESPONSE))
#define TSS2_ESYS_RC_INCOMPATIBLE_TCTI \
    ((TSS2_RC) (TSS2_ESYS_RC_LAYER | TSS2_BASE_RC_INCOMPATIBLE_TCTI))
#define TSS2_ESYS_RC_BAD_TCTI_STRUCTURE \
    ((TSS2_RC) (TSS2_ESYS_RC_LAYER | TSS2_BASE_RC_BAD_TCTI_STRUCTURE))
...
#define TSS2_ESYS_RC_MULTIPLE_DECRYPT_SESSIONS \
    ((TSS2_RC) (TSS2_ESYS_RC_LAYER | TSS2_BASE_RC_MULTIPLE_DECRYPT_SESSIONS))
#define TSS2_ESYS_RC_MULTIPLE_ENCRYPT_SESSIONS \
    ((TSS2_RC) (TSS2_ESYS_RC_LAYER | TSS2_BASE_RC_MULTIPLE_ENCRYPT_SESSIONS))
#define TSS2_ESYS_RC_NOT_SUPPORTED \
    ((TSS2_RC) (TSS2_ESYS_RC_LAYER | TSS2_BASE_RC_NOT_SUPPORTED))
...
#define TSS2_FAPI_RC_SIGNATURE_VERIFICATION_FAILED \
    ((TSS2_RC)(TSS2_FEATURE_RC_LAYER | TSS2_BASE_RC_SIGNATURE_VERIFICATION_FAILED))
...
#define TSS2_FAPI_RC_NO_CERT \
    ((TSS2_RC)(TSS2_FEATURE_RC_LAYER | TSS2_BASE_RC_NO_CERT))
