 ...
 * ABI-compatible layout: bit-fields are replaced by two uint64_t so that
 * cinterop/Kotlin Native can parse the struct (bit-fields cause "not a structure or too complex").
 * Layout (little-endian): part0 = valid:1 | ver:3 | chainId:60; part1 = flags:12 | spanId:26 | parentSpanId:26.
 *
 * @struct HiTraceId
 *
 * @syscap SystemCapability.HiviewDFX.HiTrace
